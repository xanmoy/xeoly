...
export default function SearchBox() {
  ...
  return (
    <form
      className="flex bg-neutral-800 rounded-full shadow-lg px-6 py-3 ml-10 mr-5 flex-grow max-w-3xl items-center"
      onSubmit={handleSubmit}
    >
      <input
        type="text"
        className="w-full bg-neutral-800 focus:outline-none"
        value={term}
